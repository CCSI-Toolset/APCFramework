function [z,exitflag,iter,lam,t] = quad_mehrotra(H,f,A,b,maxiter,tol,verbose,z0,lam0,t0)
% Solve quadratic programming problem using Wright's Method & Mehrota's Predictor - Corrector Method
